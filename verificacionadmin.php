                            ...
                            <ul class="nav navbar-nav menu_nav ml-auto">
                                ...
                                <li class="nav-item submenu dropdown">
                                 ...
                                 <li class="nav-item submenu dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="nav-item"><a class="nav-link" href="solicitudes.php">Historial de registros</a>

                                        </a></li>
                                        <li class="nav-item"><a class="nav-link" href="controlsolicitudes.php">Registros por edades</a>

                                        </a></li>
                                        <li class="nav-item"><a class="nav-link" href="controlsolicitudes.php">res</a>

                                        </a></li>
                                        <li class="nav-item"><a class="nav-link" href="solicitudes.php">ir a control</a>
            ...
            <br><br><br><br>
                        ...
                        <div class="contact_info">
                            ...
                            <div class="info_item">
                                ...
                                <center>
                                <h3>Tu pre registro a sido guardado exitosamente</h3>
                                </center>
